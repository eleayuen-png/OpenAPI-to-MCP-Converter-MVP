...
var require_convert_path_to_posix = __commonJS({
  "node_modules/@apidevtools/json-schema-ref-parser/dist/lib/util/convert-path-to-posix.js"(exports) {
    "use strict";
    ...
    function convertPathToPosix(filePath) {
      ...
      return filePath.split((_b = (_a = path_1.default) == null ? void 0 : _a.win32) == null ? void 0 : _b.sep).join(((_d = (_c = path_1.default) == null ? void 0 : _c.posix) == null ? void 0 : _d.sep) ?? "/");
    }
  }
});
...
var require_is_windows = __commonJS({
  "node_modules/@apidevtools/json-schema-ref-parser/dist/lib/util/is-windows.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
var require_url = __commonJS({
  "node_modules/@apidevtools/json-schema-ref-parser/dist/lib/util/url.js"(exports) {
    ...
    var path_1 = __importStar(require_path());
    ...
    function resolve(from, to) {
      ...
      const endSpaces = ((_a = to.match(/(\s*)$/)) == null ? void 0 : _a[1]) || "";
    ...
    function fromFileSystemPath(path) {
      ...
      if ((0, is_windows_1.isWindows)()) {
        ...
        const isAbsolutePath = ((_a = path_1.win32) == null ? void 0 : _a.isAbsolute(path)) || path.startsWith("http://") || path.startsWith("https://") || path.startsWith("file://");
      ...
      resolve(obj, options, pathFromRoot) {
        ...
        for (let i = 0; i < tokens.length; i++) {
          ...
          if (this.value[token] === void 0 || this.value[token] === null && i === tokens.length - 1) {
            ...
            const parentPath = pathFromRoot == null ? void 0 : pathFromRoot.replace(path, "");
...
var require_ref2 = __commonJS({
  "node_modules/@apidevtools/json-schema-ref-parser/dist/lib/ref.js"(exports) {
    ...
    var $Ref = class _$Ref {
      ...
      get(path, options) {
        var _a;
        return (_a = this.resolve(path, options)) == null ? void 0 : _a.value;
      }
      /**
      ...
      static isAllowed$Ref(value, options) {
        ...
        if (this.is$Ref(value)) {
          if (value.$ref.substring(0, 2) === "#/" || value.$ref === "#") {
            return true;
          } else if (value.$ref[0] !== "#" && (!options || ((_a = options.resolve) == null ? void 0 : _a.external))) {
            return true;
          }
        }
        return void 0;
      ...
      async parse(file) {
        ...
        if (typeof data === "string") {
          try {
            ...
            throw new errors_js_1.ParserError((e == null ? void 0 : e.message) || "Parser Error", file.url);
          }
        } else {
          return data;
        }
...
var require_resolve_external = __commonJS({
  "node_modules/@apidevtools/json-schema-ref-parser/dist/lib/resolve-external.js"(exports) {
    ...
    function resolveExternal(parser, options) {
      var _a;
      if (!((_a = options.resolve) == null ? void 0 : _a.external)) {
    ...
    async function resolve$Ref($ref, path, $refs, options) {
      var _a;
      const shouldResolveOnCwd = ((_a = options.dereference) == null ? void 0 : _a.externalReferenceResolution) === "root";
      ...
      try {
        ...
        if (!(options == null ? void 0 : options.continueOnError) || !(0, errors_js_1.isHandledError)(err)) {
          throw err;
        }
...
var require_dereference = __commonJS({
  "node_modules/@apidevtools/json-schema-ref-parser/dist/lib/dereference.js"(exports) {
    ...
    function crawl(obj, path, pathFromRoot, parents, processedObjects, dereferencedCache, $refs, options, startTime) {
      ...
      if ((derefOptions == null ? void 0 : derefOptions.circular) === "ignore" || !processedObjects.has(obj)) {
            ...
            for (const key of Object.keys(obj)) {
              ...
              if (ref_js_1.default.isAllowed$Ref(value, options)) {
                ...
                if (obj[key] !== dereferenced.value) {
                  ...
                  if (derefOptions == null ? void 0 : derefOptions.preservedProperties) {
                    if (typeof obj[key] === "object" && !Array.isArray(obj[key])) {
                      derefOptions == null ? void 0 : derefOptions.preservedProperties.forEach((prop) => {
                        if (prop in obj[key]) {
                  ...
                  (_a = derefOptions == null ? void 0 : derefOptions.onDereference) == null ? void 0 : _a.call(derefOptions, value.$ref, obj[key], obj, key);
                }
              } else {
    ...
    function dereference$Ref($ref, path, pathFromRoot, parents, processedObjects, dereferencedCache, $refs, options, startTime) {
      ...
      const shouldResolveOnCwd = isExternalRef && ((_a = options == null ? void 0 : options.dereference) == null ? void 0 : _a.externalReferenceResolution) === "root";
      ...
      if (circular && !directCircular && ((_b = options.dereference) == null ? void 0 : _b.circular) === "ignore") {
    ...
    function foundCircularReference(keyPath, $refs, options) {
      var _a, _b;
      $refs.circular = true;
      (_b = (_a = options == null ? void 0 : options.dereference) == null ? void 0 : _a.onCircular) == null ? void 0 : _b.call(_a, keyPath);
...
var require_lib4 = __commonJS({
  "node_modules/@apidevtools/swagger-parser/lib/index.js"(exports, module) {
    ...
    var SwaggerParser = class extends $RefParser {
      /**
...
//# sourceMappingURL=@apidevtools_swagger-parser.js.map
